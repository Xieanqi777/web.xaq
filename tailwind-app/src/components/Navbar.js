...
export default function Navbar() {
  return (
    <nav className="horizontal-nav bg-[var(--morandiPurple)] shadow-md py-3 px-6 mb-6">
      <div className="container mx-auto flex justify-between items-center">
        ...
        <div className="flex space-x-2">
          ...
          <Link href="/qanything" className="horizontal-btn bg-[var(--morandiLightPurple)] text-white hover:bg-[var(--morandiDarkPurple)]">
            QAnything
          </Link>
