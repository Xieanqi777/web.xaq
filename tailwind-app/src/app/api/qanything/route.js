...
const QANYTHING_CONFIG = {
  appKey: 'qanything-WghqgR0VxRsdDwjcgzizOGegqfMPxjPY', // 用户提供的 API KEY
  adminKey: 'qanything-WghqgR0VxRsdDwjcgzizOGegqfMPxjPY', // 管理秘钥
  baseUrl: 'https://openapi.youdao.com/q_anything/api', // API 基础地址
  kbIds: ['KB859adc70128e4088972bcaa7da1e5ee6_240430'] // 确保默认知识库ID正确
};
